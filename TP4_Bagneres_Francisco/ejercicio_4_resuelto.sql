...
nro_hist_clinico int primary key,
nss int,
nombre varchar(30),
apellido varchar(30),
...
ingreso INT primary key,
fecha_ingreso DATE,
nro_habitacion INT,
nro_cama INT,
observaciones TEXT,
num_historial_paciente INT,
matricula_medico INT,
foreign key (num_historial_paciente) references paciente (nro_hist_clinico),  
...
insert into paciente (nss, nombre, apellido, domicilio, codigo_postal, telefono, nro_hist_clinico, observaciones)
           ...
           insert into ingreso (ingreso, fecha_ingreso, nro_habitacion, nro_cama, observaciones, num_historial_paciente, matricula_medico)
		   VALUES
